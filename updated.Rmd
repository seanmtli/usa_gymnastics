...
sims_data <- read_csv("App-1/data/07_24_2024_sims/AA_usa_womens_sims.csv")
percs <- calculatePodiumPercentages(sims_data, allroudwomen_cutoffs)
write.csv(percs, 'App-1/data/07_24_2024_sims/w_AA.csv', row.names=FALSE)
```
