...
BB_sims <- read_csv("App-1/data/BB_usa_womens_sims.csv")
FX_sims <- read_csv("App-1/data/FX_usa_womens_sims.csv")
UB_sims <- read_csv("App-1/data/UB_usa_womens_sims.csv")
VT_sims <- read_csv("App-1/data/VT_usa_womens_sims.csv")
...
HB_sims_m <- read_csv("App-1/data/HB_usa_mens_sims.csv")
FX_sims_m <- read_csv("App-1/data/FX_usa_mens_sims.csv")
PB_sims_m <- read_csv("App-1/data/PB_usa_mens_sims.csv")
VT_sims_m <- read_csv("App-1/data/VT_usa_mens_sims.csv")
PH_sims_m <- read_csv("App-1/data/PH_usa_mens_sims.csv")
SR_sims_m <- read_csv("App-1/data/SR_usa_mens_sims.csv")
