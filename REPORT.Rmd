...
f_probs <- read_csv('/home/guest/Case2-BDSM/Data/expected_medals/f_total_probabilities.csv')
...
\newpage
```{r, echo=FALSE, warning= FALSE, message=FALSE}
m_probs <- read_csv('/home/guest/Case2-BDSM/Data/expected_medals/m_total_probabilities.csv')
