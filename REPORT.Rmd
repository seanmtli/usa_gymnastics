...
```{r, echo=FALSE}
results <- data.frame(
  Category = c("All Around", "All Around", "Specialist", "Specialist", "Specialist", "Pred. Medals"),
  USA_Women = c( "Simone Biles", "Shilese Jones", "Skye Blakely", "Jade Carey", "Zoe Miller", "4.565"),
  USA_Men = c("Fredrick Richard", "Paul Juda", "Donnell Whittenburg", "Khoi Young", "Curran Phillips", "2.402")
)
kable(results, caption = "Results for USA Gymastics Team, with Predicted Medal Counts")
```

To maximize for total medal count at the Paris 2024 Olympics, the USA Gymnastics team should select Simone Biles, Skye Blakely, Shilese Jones, Jade Carey, and Zoe Miller for the women’s team, and Fredrick Richard, Paul Juda, Donnell Whittenburg, Khoi Young, and Curran Phillips for the men’s team. Our total predicted medal counts are 4.565 individual medals for women, and 2.402 for the men’s team. 

Biles and Jones are the clear all-round selection, expecting to contribute XX and XX medals in total respectively, and having XX% and XX% to medal in the individual all-around finals. Onto the three specialists, Carey is an outstanding performer in Vault and Floor Exercise, having XX% and XX% to medal in those apparatus. Skye Blakely has an expected medal contribution of XX, with her best events in UB and BB. Miller is our last selection, and she brings value in the Uneven Bars, having a %% percent of medaling there. 

Juda and Richard were the all-round selections on the men's side. They have the highest chances of medaling in our individual all-round, with XX% and XX% respectively. The first specialist we choose was Khoi Young for his ability in VT, having X% of medaling there. Then we choose veteran Whittenburg for his consistency on the still rings (SR), having the highest % to help the US medal in that apparatus with X%. Lastly, we went with Curran Phillips for ???? as he had X% to medal in (EVENTNAME).
