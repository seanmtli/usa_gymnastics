...
```{r}
results <- data.frame(
  Category = c("All Around", "All Around", "Specialist", "Specialist", "Specialist", "Pred. Medal Count"),
  USA_Women = c( "Simone Biles", "Shilese Jones", "Skye Blakely", "Jade Carey", "Zoe Miller", "4.314"),
  USA_Men = c("Value2", "Value3", "Value4", "Value5", "Value6", "0")
)
