...
```{r medal-counts-f}
f_FX <- read_csv("Data/event_percentages/f_FX.csv")
f_BB <- read_csv("Data/event_percentages/f_BB.csv")
f_VT <- read_csv("Data/event_percentages/f_VT.csv")
f_UB <- read_csv("Data/event_percentages/f_UB.csv")
...
```{r medal-counts-m}
m_FX <- read_csv("Data/event_percentages/m_FX.csv")
m_SR <- read_csv("Data/event_percentages/m_SR.csv")
m_VT <- read_csv("Data/event_percentages/m_VT.csv")
m_PB <- read_csv("Data/event_percentages/m_PB.csv")
m_PH <- read_csv("Data/event_percentages/m_PH.csv")
m_HB <- read_csv("Data/event_percentages/m_HB.csv")
...
BB_sims <- read_csv("Data/BB_usa_womens_sims.csv")
FX_sims <- read_csv("Data/FX_usa_womens_sims.csv")
UB_sims <- read_csv("Data/UB_usa_womens_sims.csv")
VT_sims <- read_csv("Data/VT_usa_womens_sims.csv")
...
condensed_data <- data.frame(matrix(NA, nrow = nrow(noname), ncol = 1000))
...
HB_sims_m <- read_csv("Data/HB_usa_mens_sims.csv")
FX_sims_m <- read_csv("Data/FX_usa_mens_sims.csv")
PB_sims_m <- read_csv("Data/PB_usa_mens_sims.csv")
VT_sims_m <- read_csv("Data/VT_usa_mens_sims.csv")
PH_sims_m <- read_csv("Data/PH_usa_mens_sims.csv")
SR_sims_m <- read_csv("Data/SR_usa_mens_sims.csv")
